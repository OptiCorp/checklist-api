...
public class GetByIdCommandHandler : IRequestHandler<GetByIdCommand, ItemTemplateDto?>
{
    ...
    public async Task<ItemTemplateDto?> Handle(GetByIdCommand request, CancellationToken cancellationToken)
    {
